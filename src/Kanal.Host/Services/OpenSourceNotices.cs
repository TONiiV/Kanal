...
// and that is not shipped yet — see docs/PROGRESS.md. Maintained by hand: a PackageReference added
// anywhere under src/ or tools/ needs its entry here, in the same PR, or this list is quietly wrong.
