...
public class HostUiTests
{
    ...
    // kanal.ico is generated by design/kanal-icon.py, which writes the ICO
    // container by hand — a malformed one would only surface as a missing Dock
    // and taskbar icon at runtime, never as a build error.
    [AvaloniaFact]
