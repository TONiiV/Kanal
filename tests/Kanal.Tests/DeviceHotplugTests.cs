...
public class DeviceHotplugTests
{
    ...
    /// <summary>
    /// The one thing the native wrappers can prove headlessly: registering and removing the
    /// real platform listener neither throws nor corrupts the process (a wrong P/Invoke
    /// signature dies here, not in a meeting). Firing it still needs the manual test above.
    /// </summary>
    [Fact]
    public void TheRealWatcherRegistersAndUnregistersCleanly()
    {
