...
it; the licence texts themselves are not yet shipped with the binary. Downloaded translation models
and external services have their own licences and terms; the model catalog displays the relevant
licence for each model, including a warning where it is not OSI-approved.
